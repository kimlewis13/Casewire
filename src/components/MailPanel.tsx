      ...
      <div className="rounded-2xl border border-border bg-surface p-5">
        ...
        {!showDeliverForm ? (
          <button
            ...
            className="mt-4 rounded-full border border-border bg-background px-4 py-2 text-sm font-semibold transition hover:border-accent-2 hover:text-accent-2"
          >
            Mark as delivered
          </button>
        ) : (
          <div className="mt-4 flex flex-col gap-3 rounded-xl border border-border bg-background p-4">
            <label className="flex flex-col gap-1 text-sm">
              ...
              <input
                ...
                className="rounded-lg border border-border bg-surface px-3 py-2 text-sm outline-none focus:border-accent-2"
              />
            </label>
            <label className="flex flex-col gap-1 text-sm">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="rounded-lg px-4 py-2 text-sm font-semibold text-muted hover:text-foreground"
              >
                Cancel
              </button>
            </div>
    ...
    <div className="rounded-2xl border border-border bg-surface p-5">
      ...
      {!showSendForm ? (
        <button
          ...
          className="mt-4 rounded-full bg-accent px-4 py-2.5 text-sm font-semibold text-accent-foreground transition hover:brightness-105"
        >
